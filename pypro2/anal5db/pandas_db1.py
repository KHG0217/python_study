...
import sqlite3
sql = "create table if not exists test(product varchar(10), maker varchar(10), weight real, price inreger)"
...
# pandas로 바로 sql을 읽고 Dataframe으로 넣기
df2 = pd.read_sql("select * from test",conn)
print(df2)
# print(df2.to_html()) # dataFrame이 html형식으로 만들어 짐
print()
