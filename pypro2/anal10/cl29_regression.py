# sk-learn 라이브러리가 제공하는 몇 가지 Regression 클래스 사용
import pandas as pd
import numpy as np
...
adver = pd.read_csv('../testdata/Advertising.csv', usecols=[1,2,3,4]) # usecols 사용할 칼럼만
print(adver.head(2))
...
print('real : ', y[:5])
print('l_r2 : ', r2_score(y, lpred)) # l_r2 :  0.897
print()
...
print('real : ', y[:5])
print('r_r2 : ', r2_score(y, rpred)) # r_r2 :  0.997
print()
...
print('real : ', y[:5])
print('x_r2 : ', r2_score(y, xpred)) # x_r2 :  0.999
print()
...
print('real : ', y[:5])
print('k_r2 : ', r2_score(y, kpred)) # k_r2 :  0.968
print()
...
print('real : ', y[:5])
print('s_r2 : ', r2_score(y, spred)) # s_r2 :  0.889
print()