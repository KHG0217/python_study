...
# 검정통계량 chi2:6.544667820529891, p-value:0.5864574374550608, df:8
# 해석 : p - value > 0.05 크므로 귀무가설 채택 대리가설 기각
# 귀무가설: 교육방법에 따른 교육생들의 만족도 차이가 없다.
print('-'*50)
