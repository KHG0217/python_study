...
ctab = pd.crosstab(index = data['education'], columns=data['smoking'] ) # ,normalize=True 비율보기
ctab.index = ['고졸','대졸','대학원졸']
ctab.columns = ['과흡연','보통','노담']
print(ctab)
print()

chi_result = [ctab.loc['고졸'],ctab.loc['대졸'],ctab.loc['대학원졸']] # 특정값만 빼내서 계산하고 싶을때
print(chi_result)
print()
...
# chi2:18.910915739853955, p-value:0.0008182572832162924, df:4 df:자유도
...
print(chi2,p)
# chi2:18.099524243141698  p-value:0.0011800326671747886
# 해석: p-value <0.001180 < 0.05 이므로 귀무가설 기각 대립가설 채택
#     국가전체와 지역에 대한 인종 간 인원수는 관련이 있다. (독립적이지 않다.)
