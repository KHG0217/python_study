...
loss_metrics = model.evaluate(x=x_data, y=y_data,batch_size=1, verbose=2)
...
loss_metrics2 = model2.evaluate(x=x_data, y=y_data,batch_size=1, verbose=2)
