...
# 위 처럼 one_hot_func 함수를 사용 안하고 to_categorical을 사용해 원핫 인코딩을 실행.
...
# 'categorical_crossentropy' : 모델이 예측한 확률분포와 실제값 확률분포의 거리를 계산. 두 분포 사이에 거리가 최소화하도록 함.

# validation data를 만들수도 있다. 그러나 생략...
